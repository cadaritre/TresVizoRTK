...
| Batería | Alimentación portátil | 955565, LiPo 1S, 3.7 V / 5000 mAh / 18.5 Wh anunciados | Publicación indicada por el propietario; sin caracterización física | Dos cables en imagen; capacidad real, dimensiones, conector, PCM, corriente admisible y NTC por confirmar. Ver [referencia de batería](references/BATTERY_REFERENCE.md). |
