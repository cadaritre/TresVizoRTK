...
| U02 | No exceder corriente permitida | Consumo total: sistema, carga, bridge y lógica. Probar pre-enumeración, configurado, suspendido, Rp default/1.5/3 A y fuente débil. |
...
| D01 | USB-UART a ESP externo | TX/RX/GND y reserva DTR/RTS; GPIO/pinout TBD. Probar carga de firmware, reset, reconexión y Mac. |
| D02 | Evitar alimentación parásita | UART/DTR/RTS/I2C/ALERT/LEDs aislados o con Ioff apropiado en ambos sentidos; verificar placa apagada con USB. |
...
| T01 | Diagnóstico V1 | TP VBUS, BAT+, GND, SYSTEM_POWER, SYSTEM_5V, 3V3 si existe, TX/RX, HOLD, REQUEST, CHG/PG y SDA/SCL/ALERT si gauge. |
