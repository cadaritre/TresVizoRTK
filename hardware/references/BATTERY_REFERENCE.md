...
> Evidencia de identificación conservada. La alimentación vigente está en [power-modules](../power-modules/README.md); el apartado sobre Power Board es histórico y no prescribe una PCB personalizada actual.
