...
Se conservan seis impresiones permanentes en el receptor y una plantilla reutilizable que se retira después de alinear. [Lista completa y orientación de impresión](PRINT-AND-ASSEMBLY.md).
...
Se comprobaron sólidos, contacto de apriete y nueve posiciones XY sin intersecciones de las piezas representadas. Se comprobó la inserción de la cuna y se prepararon mallas cerradas. No se ensayó el conjunto impreso ni su rigidez/repetibilidad. Los detalles de la revisión están en [impresión y montaje](PRINT-AND-ASSEMBLY.md).
