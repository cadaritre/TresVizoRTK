...
fig.text(.045,.915,'CAD reconstruido · 7 piezas impresas · base de una pieza',fontsize=15,color='#354944')
...
for x,title,caption in [(.045,'EXTERIOR CONSERVADO','Tapa + asiento de antena integrados.\nPaso coaxial central visible al retirar antena.'),(.36,'ESTRUCTURA NUEVA','Espina de 4 mm y cuna amplia.\nSe eliminan varillas y adaptadores sueltos.'),(.70,'RESERVAS DE COMPONENTES','Coaxial azul fuera de batería e IMU.\nLas reservas no son réplicas de las placas.')]:
