...
| --- | ---: | ---: | --- | --- |
| M3 cabeza boton ISO 7380 | 14 mm | **1** | Seguro de la base. Rosca en el macizo de la base. | util 13.2 mm |
| M3 cabeza boton ISO 7380 | 10 mm | **1** | Seguro de la tapa. Rosca en el cuello de la tapa. | util 8.7 mm |
| M3 cabeza boton ISO 7380 | 6 mm | **2** | Tapa del panel principal. Rosca en el engrosamiento. | agarre 4.2 mm, puede asomar 14 mm |
| M3 cabeza boton ISO 7380 | 6 mm | **2** | Tapa del panel auxiliar. Rosca en el engrosamiento. | agarre 4.2 mm, puede asomar 14 mm |
| M2.5 cilindrica ISO 4762 | 10 mm | **3** | Antena. Sube desde dentro y rosca en la antena. | tapa 5 + 4 en la antena |
...
**11 tornillos con longitud definida y 2 tuercas.** El resto queda a criterio al accesorizar.
...
- La penetracion en la rosca de la antena se supone 4 mm. Medirla antes de comprar: un tornillo largo de mas toca fondo y no aprieta.
